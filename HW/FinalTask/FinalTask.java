...
public class FinalTask {
    ...
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Xiaomi", 32, 1024, "Windows", "Gray"));
        laptops.add(new Laptop("Apple", 8, 256, "MacOS", "Silver"));
        laptops.add(new Laptop("Lenovo", 16, 512, "Windows", "Black"));
        laptops.add(new Laptop("Lenovo", 64, 1024, "Windows", "Black"));
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            System.out.println("0 - Применить");
